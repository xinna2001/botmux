...
export const messages: Record<string, string> = {
  ...
  'ai.routing.intro': 'You are in an IM conversation connected by botmux. The user cannot see terminal output — you MUST reply via `botmux send`.',
  ...
  'ai.shell.intro': 'You are running inside an IM conversation connected by botmux. The user reads in their chat client and cannot see your terminal output.',
  ...
  'ai.followup.reminder_hook': 'This session is bridged to an IM platform via botmux; terminal output is not visible to the user. Session convention: send replies via `botmux send`; what and how many to send is your call. Only when a message is not for you make the final just the single word BOTMUX_NOTHING_TO_SEND.',
